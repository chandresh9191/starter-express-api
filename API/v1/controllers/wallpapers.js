...
async function tableData(req, res) {
    return new Promise(async(resolve, reject) => {
        try {
            var find = await databaseClass.findDataNew(req.query.tb_name, {}, {
                _id: 0
            }, {}, 0, 0);
            console.log("find ---->", find.length);
            return resolve({
                status: 200,
                msg: 'Table data of ' + req.query.tb_name,
                data: find
            });
        } catch (error) {
            return reject(error);
...
async function wallpaperData (req, res) {
    return new Promise(async(resolve, reject) => {
        try {
            ...
            return resolve({
                status: 200,
                msg: req.query.category + ' wallpaper Data',
                data: shuffled
            });
        }catch (error) {
            return reject(error);
...
async function select_image (req, res) {
    return new Promise(async(resolve, reject) => {
        try {
            ...
            return resolve({
                status: 200,
                msg: 'Selected image fetched successfully',
                data: find
            });
        }catch (error) {
            return reject(error);
...
async function thumbnail (req, res) {
    return new Promise(async(resolve, reject) => {
        try {
            ...
            return resolve({
                status: 200,
                msg: 'Fetched thumbnails successfully',
                data: data
            });
        }catch (error) {
            return reject(error);
    ...
    return new Promise(async(resolve, reject) => {
        try {
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/photos/random/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&count=30');
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=architecture&per_page=30&page=' + page);
            var data = JSON.parse(response);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=animal&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=birds&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=ocean&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=nature&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=winter&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=beach&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=lights&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=flowers&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ***/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=reflection&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=love&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=fireworks&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=galaxy&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=vehicle&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=aircraft&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=music&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
            ...
            ****/
            ...
            var response = await doRequest('https://api.unsplash.com/search/photos/?client_id=7d24b048ee77412a6c0ef802e337a07b3bf76a41aa2bb2985b2319b581c8d138&query=food&per_page=30&page=' + page);
            var data = JSON.parse(response);
            console.log("data.result.length -->", data.results.length);
